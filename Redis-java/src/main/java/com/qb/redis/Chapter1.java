...
public class Chapter1 extends AbstractChapter {
	...
	public void testChapter1() {
		...
		jedis.set("test", "www.liufeng.com");
		System.out.println("The store data of Redis is " + jedis.get("test"));
		jedis.select(15);
	...
	private void printAllArticles(List<Map<String, String>> articles) {
